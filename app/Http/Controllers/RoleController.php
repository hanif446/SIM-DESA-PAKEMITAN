...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('roles.index')->with('message', 'Data berhasil disimpan!');
    ...
    public function update(Request $request, Role $role)
    {
        ...
        try {
            ...
            return redirect()->route('roles.index')->with('message', 'Data berhasil diubah!');
    ...
    public function destroy(Role $role)
    {
        if(User::role($role->name)->count()){
            ...
            return redirect()->route('roles.index')->with('warning', 'Sorry ' .$role->name . ' role cannot be deleted. Because it is still in use.');
        }
