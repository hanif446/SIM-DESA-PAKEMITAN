                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_pegawai_jabatan" value="{{old('jabatan')}}" name="jabatan" type="text" class="form-control @error('jabatan') is-invalid @enderror" placeholder="Input Jabatan" />
                                <!-- error message -->
                                @error('jabatan')
                                  <span class="invalid-feedback">
                                    <strong>{{$message}}</strong>
                      ...
                      <div class="col-md-6">
                        <!-- pendidikan -->
                          <div class="form-group">
                              ...
                              <select id="input_pegawai_pendidikan_terakhir" name="pendidikan_terakhir" class="form-control @error('pendidikan_terakhir') is-invalid @enderror">
                                  ...
                                  <option value="SLTP" @if(old('pendidikan_terakhir') == 'SLTP') selected @endif>SLTP</option>
                                  <option value="SLTA" @if(old('pendidikan_terakhir') == 'SLTA') selected @endif>SLTA</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_pegawai_no_sk_pengangkatan" value="{{old('no_sk_pengangkatan')}}" name="no_sk_pengangkatan" type="text" class="form-control @error('no_sk_pengangkatan') is-invalid @enderror" placeholder="Input No SK Pengangkatan" />
                                <!-- error message -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select style="cursor:pointer;" class="form-control @error('thn_sk_pengangkatan') is-invalid @enderror"  name="thn_sk_pengangkatan">
                                  ...
                                  {{$max = $year + 20}}
                                  @for( $i=$max; $i>=$min; $i-- ) 
                                    <option value="{{$i}}" {{ old('thn_sk_pengangkatan') == $i ? "selected" : null}}>{{$i}}</option>
                                  @endfor
                                </select>
                              <!-- error message -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_pegawai_foto" value="{{old('foto')}}" name="foto" type="file" class="form-control @error('foto') is-invalid @enderror" placeholder="Input Foto" />
                                <!-- error message -->
                                @error('foto')
                                  <span class="invalid-feedback">
                                    <strong>{{$message}}</strong>
