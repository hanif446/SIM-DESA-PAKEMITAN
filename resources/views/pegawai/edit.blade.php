                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_pegawai_nip" value="{{old('nip', $pegawai->nip)}}" name="nip" type="text" class="form-control @error('nip') is-invalid @enderror" onkeypress="return event.charCode>=48 && event.charCode<=57"  placeholder="Input NIP"/>
                                <!-- error message -->
                                @error('nip')
