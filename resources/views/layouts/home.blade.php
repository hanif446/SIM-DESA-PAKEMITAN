...
<html lang="en">
  ...
  <body>
    ...
    <header id="slider-area">   
      ...
      @include('layouts._homepage.carousel')

    </header>
    <!-- Header Section End --> 

    <!-- Call to Action Start -->
      @include('layouts._homepage.profil')
    <!-- Call to Action End -->
    
    <!-- Counter Section Start -->
      @include('layouts._homepage.penduduk')
    <!-- Counter Section End -->

    <!-- Portfolio Section -->
      @include('layouts._homepage.porto')

    <!-- Portfolio Section Ends --> 

    <!-- Profil Section Start -->
      @include('layouts._homepage.petugas')
    <!-- Profil Section End --> 

    <!-- Map Section Start -->
      @include('layouts._homepage.map')
    <!-- Map Section End -->
